<template>
    <div class="flex justify-center items-center">
      <div class="">
        <p>IDIngresso: {{ ticket.attributes.reference_number }}</p>
  
        <p>
          Assentos sem pipoca e bebidas:
          {{ ticket.attributes.seats_without }} seats
        </p>
  
        <p>
          Assentos com pipoca e bebidas: {{ ticket.attributes.seats_with }} seats
        </p>
  
        <p>Preço Total: ${{ ticket.attributes.total }}.00</p>
